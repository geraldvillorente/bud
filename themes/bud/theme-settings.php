 ...
 */
function bud_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['bud_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('bud sample setting'),
  '#default_value' => theme_get_setting('bud_example'),
